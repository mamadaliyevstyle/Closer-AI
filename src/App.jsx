...
import { Copy, CheckCircle2, UserCircle, Briefcase, Tag, HelpCircle, Sparkles, LayoutDashboard, PhoneCall } from 'lucide-react';
          ...
          <div className="dashboard-container">
            <div className="dashboard-header">
              <div className="header-logo">
                ...
                <h1>Widget <span className="subtitle">Setup</span></h1>
              </div>
